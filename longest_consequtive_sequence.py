...
def longest_consecutive(nums: list[int]) -> int:
    ...
    ns = set(nums)
    for n in ns:
        key_min_value_max = dict_key_min_value_max[n + 1]
        key_max_value_min = dict_key_max_value_min[n - 1]
        if type(key_min_value_max) == int:
            if key_max_value_min:
                dict_key_max_value_min[key_min_value_max] = key_max_value_min
                dict_key_min_value_max[key_max_value_min] = key_min_value_max
                dict_key_min_value_max[n + 1] = False
                dict_key_max_value_min[n - 1] = False
            else:
                dict_key_min_value_max[n] = key_min_value_max
                dict_key_max_value_min[key_min_value_max] = n
                dict_key_min_value_max[n + 1] = False
        elif type(key_max_value_min) == int:
            dict_key_max_value_min[n] = key_max_value_min
            dict_key_min_value_max[key_max_value_min] = n
            dict_key_max_value_min[n - 1] = False
        else:
    ...
    for k, v in dict_key_min_value_max.items():
        if (isinstance(v, int)) and ((v - k) > res):
            res = v - k
    return res + 1

...
if __name__ == '__main__':
    tests = [{'nums': [7, 4, 3, 9, 1, 8, 5, 2, 6], 'k': 3, 'expected': [-1, -1, -1, 5, 4, 4, -1, -1, -1]},
             {'nums': [100000], 'k': 0, 'expected': [100000]},
             {'nums': [8], 'k': 100000, 'expected': [-1]}]
    for test in tests:
        print(test, get_averages(test['nums'], test['k']))
